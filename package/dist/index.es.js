...
import { Grid, IconButton, MenuItem, Box, Typography, Paper, List, ListItem, ListItemText, Divider } from '@mui/material';
...
var Header = function (_a) {
    ...
    return (React__default.createElement(StyledGrid, { container: true, justifyContent: "space-between", alignItems: "center" },
        React__default.createElement(Grid, { item: true, className: classes.iconContainer },
            React__default.createElement(IconButton, { className: classes.icon, disabled: prevDisabled, onClick: onClickPrevious, size: "large" },
                React__default.createElement(ChevronLeft, { color: prevDisabled ? 'disabled' : 'action' }))),
        React__default.createElement(Grid, { item: true },
            React__default.createElement(Select, { variant: "standard", value: dateFns_63(date), onChange: handleMonthChange, MenuProps: { disablePortal: true } }, MONTHS.map(function (month, idx) { return (React__default.createElement(MenuItem, { key: month, value: idx }, month)); }))),
        React__default.createElement(Grid, { item: true },
            React__default.createElement(Select, { variant: "standard", value: dateFns_68(date), onChange: handleYearChange, MenuProps: { disablePortal: true } }, generateYears(date, 30).map(function (year) { return (React__default.createElement(MenuItem, { key: year, value: year }, year)); }))),
        React__default.createElement(Grid, { item: true, className: classes.iconContainer },
            React__default.createElement(IconButton, { className: classes.icon, disabled: nextDisabled, onClick: onClickNext, size: "large" },
...
var Day = function (_a) {
    ...
    return (createElement(Root, { leftBorderRadius: startOfRange, rightBorderRadius: endOfRange, highlighted: !disabled && highlighted },
        createElement(StyledIconButton, { outlined: !disabled && outlined, filled: !disabled && filled, disabled: disabled, onClick: onClick, onMouseOver: onHover, size: "large" },
            createElement(StyledTypography, { color: !disabled ? 'textPrimary' : 'textSecondary', contrast: !disabled && filled, variant: "body2" }, value))));
};
...
var StyledPaper = styled(Paper)(function () {
    var _a;
    return (_a = {},
...
var Month = function (props) {
    ...
    return (createElement(StyledPaper, { square: true, elevation: 0, className: classes$1.root },
        createElement(Grid, { container: true },
            ...
            createElement(Grid, { item: true, container: true, direction: "row", justifyContent: "space-between", className: classes$1.weekDaysContainer }, WEEK_DAYS.map(function (day) { return (createElement(Typography, { color: "textSecondary", key: day, variant: "caption" }, day)); })),
            createElement(Grid, { item: true, container: true, direction: "column", justifyContent: "space-between", className: classes$1.daysContainer }, chunks(getDaysInMonth$1(date), 7).map(function (week, idx) { return (
            // eslint-disable-next-line react/no-array-index-key
            createElement(Grid, { key: idx, container: true, direction: "row", justifyContent: "center" }, week.map(function (day) {
...
var StyledPaper$1 = styled(Paper)(function (_a) {
    var _b;
    var theme = _a.theme;
    return (_b = {},
    ...
    return (React__default.createElement(StyledPaper$1, { elevation: 5, square: true },
        React__default.createElement(Grid, { container: true, direction: "row", wrap: "nowrap" },
            React__default.createElement(Grid, null,
                React__default.createElement(Grid, { container: true, className: classes$2.header, alignItems: "center" },
                    React__default.createElement(Grid, { item: true, className: classes$2.headerItem },
...
var Root$1 = styled('div')(function () {
    var _a;
    return (_a = {},
...
var DateRangePickerWrapper = function (props) {
    ...
    return (createElement(Root$1, { className: classes$3.dateRangePickerContainer },
        open && (createElement("div", { className: classes$3.dateRangeBackdrop, onKeyPress: handleKeyPress, onClick: handleToggle })),
