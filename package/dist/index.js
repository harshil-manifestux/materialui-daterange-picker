...
var StylesProvider = _interopDefault(require('@mui/styles/StylesProvider'));
var styles = require('@mui/material/styles');
var material = require('@mui/material');
var ArrowRightAlt = _interopDefault(require('@mui/icons-material/ArrowRightAlt'));
...
var StyledGrid = styles.styled(material.Grid)(function () {
    var _a;
    return (_a = {},
        _a["& .".concat(classes.iconContainer)] = {
            padding: 5,
        },
        _a["& .".concat(classes.icon)] = {
            padding: 10,
            '&:hover': {
                background: 'none',
            },
...
var Header = function (_a) {
    ...
    var handleMonthChange = function (event) {
        setDate(dateFns_128(date, parseInt(event.target.value.toString())));
    };
    var handleYearChange = function (event) {
        setDate(dateFns_131(date, parseInt(event.target.value.toString())));
    };
    return (React__default.createElement(StyledGrid, { container: true, justifyContent: "space-between", alignItems: "center" },
        React__default.createElement(material.Grid, { item: true, className: classes.iconContainer },
            React__default.createElement(material.IconButton, { className: classes.icon, disabled: prevDisabled, onClick: onClickPrevious, size: "large" },
                React__default.createElement(ChevronLeft, { color: prevDisabled ? 'disabled' : 'action' }))),
        React__default.createElement(material.Grid, { item: true },
            React__default.createElement(Select, { variant: "standard", value: dateFns_63(date), onChange: handleMonthChange, MenuProps: { disablePortal: true } }, MONTHS.map(function (month, idx) { return (React__default.createElement(material.MenuItem, { key: month, value: idx }, month)); }))),
        React__default.createElement(material.Grid, { item: true },
            React__default.createElement(Select, { variant: "standard", value: dateFns_68(date), onChange: handleYearChange, MenuProps: { disablePortal: true } }, generateYears(date, 30).map(function (year) { return (React__default.createElement(material.MenuItem, { key: year, value: year }, year)); }))),
        React__default.createElement(material.Grid, { item: true, className: classes.iconContainer },
            React__default.createElement(material.IconButton, { className: classes.icon, disabled: nextDisabled, onClick: onClickNext, size: "large" },
                React__default.createElement(ChevronRight, { color: nextDisabled ? 'disabled' : 'action' })))));
};

/* eslint-disable jsx-a11y/mouse-events-have-key-events */
var Root = styles.styled(material.Box)(function (_a) {
    var theme = _a.theme, leftBorderRadius = _a.leftBorderRadius, rightBorderRadius = _a.rightBorderRadius, highlighted = _a.highlighted;
    return (__assign(__assign(__assign(__assign({}, (leftBorderRadius && {
        borderRadius: '50% 0 0 50%',
    })), (rightBorderRadius && {
        borderRadius: '0 50% 50% 0',
    })), { display: 'flex' }), (highlighted && {
        backgroundColor: theme.palette.action.hover,
    })));
});
var StyledIconButton = styles.styled(material.IconButton)(function (_a) {
    var theme = _a.theme, outlined = _a.outlined, filled = _a.filled;
    return (__assign(__assign({ height: 36, width: 36, padding: 0 }, (outlined && {
...
var StyledTypography = styles.styled(material.Typography)(function (_a) {
    var theme = _a.theme, contrast = _a.contrast;
    return (__assign({ lineHeight: 1.6 }, (contrast && {
...
var Day = function (_a) {
    ...
    return (React.createElement(Root, { leftBorderRadius: startOfRange, rightBorderRadius: endOfRange, highlighted: !disabled && highlighted },
        React.createElement(StyledIconButton, { outlined: !disabled && outlined, filled: !disabled && filled, disabled: disabled, onClick: onClick, onMouseOver: onHover, size: "large" },
            React.createElement(StyledTypography, { color: !disabled ? 'textPrimary' : 'textSecondary', contrast: !disabled && filled, variant: "body2" }, value))));
};
...
var classes$1 = {
    ...
    weekDaysContainer: "".concat(PREFIX$1, "-weekDaysContainer"),
    daysContainer: "".concat(PREFIX$1, "-daysContainer"),
};
var StyledPaper = styles.styled(material.Paper)(function () {
    var _a;
    return (_a = {},
        _a["&.".concat(classes$1.root)] = {
            width: 290,
        },
        _a["& .".concat(classes$1.weekDaysContainer)] = {
            marginTop: 10,
            paddingLeft: 30,
            paddingRight: 30,
        },
        _a["& .".concat(classes$1.daysContainer)] = {
            paddingLeft: 15,
            paddingRight: 15,
            marginTop: 15,
            marginBottom: 20,
...
var Month = function (props) {
    ...
    return (React.createElement(StyledPaper, { square: true, elevation: 0, className: classes$1.root },
        React.createElement(material.Grid, { container: true },
            ...
            React.createElement(material.Grid, { item: true, container: true, direction: "row", justifyContent: "space-between", className: classes$1.weekDaysContainer }, WEEK_DAYS.map(function (day) { return (React.createElement(material.Typography, { color: "textSecondary", key: day, variant: "caption" }, day)); })),
            React.createElement(material.Grid, { item: true, container: true, direction: "column", justifyContent: "space-between", className: classes$1.daysContainer }, chunks(getDaysInMonth$1(date), 7).map(function (week, idx) { return (
            // eslint-disable-next-line react/no-array-index-key
            React.createElement(material.Grid, { key: idx, container: true, direction: "row", justifyContent: "center" }, week.map(function (day) {
...
var DefinedRanges = function (_a) {
    ...
    return (React__default.createElement(material.List, null, ranges.map(function (range, idx) { return (
    // eslint-disable-next-line react/no-array-index-key
    React__default.createElement(material.ListItem, { button: true, key: idx, onClick: function () { return setRange(range); } },
        React__default.createElement(material.ListItemText, { primaryTypographyProps: {
                variant: 'body2',
                style: {
...
var PREFIX$2 = 'Menu';
var classes$2 = {
    header: "".concat(PREFIX$2, "-header"),
    headerItem: "".concat(PREFIX$2, "-headerItem"),
    divider: "".concat(PREFIX$2, "-divider"),
};
var StyledPaper$1 = styles.styled(material.Paper)(function (_a) {
    var _b;
    var theme = _a.theme;
    return (_b = {},
        _b["& .".concat(classes$2.header)] = {
            padding: '20px 70px',
        },
        _b["& .".concat(classes$2.headerItem)] = {
            flex: 1,
            textAlign: 'center',
        },
        _b["& .".concat(classes$2.divider)] = {
...
var Menu = function (props) {
    ...
    return (React__default.createElement(StyledPaper$1, { elevation: 5, square: true },
        React__default.createElement(material.Grid, { container: true, direction: "row", wrap: "nowrap" },
            React__default.createElement(material.Grid, null,
                React__default.createElement(material.Grid, { container: true, className: classes$2.header, alignItems: "center" },
                    React__default.createElement(material.Grid, { item: true, className: classes$2.headerItem },
                        React__default.createElement(material.Typography, { variant: "subtitle1" }, startDate ? dateFns_50(startDate, 'MMMM DD, YYYY') : 'Start Date')),
                    React__default.createElement(material.Grid, { item: true, className: classes$2.headerItem },
                        React__default.createElement(ArrowRightAlt, { color: "action" })),
                    React__default.createElement(material.Grid, { item: true, className: classes$2.headerItem },
                        React__default.createElement(material.Typography, { variant: "subtitle1" }, endDate ? dateFns_50(endDate, 'MMMM DD, YYYY') : 'End Date'))),
                React__default.createElement(material.Divider, null),
                React__default.createElement(material.Grid, { container: true, direction: "row", justifyContent: "center", wrap: "nowrap" },
                    ...
                    React__default.createElement("div", { className: classes$2.divider }),
...
var PREFIX$3 = 'DateRangePickerWrapper';
var classes$3 = {
    dateRangePickerContainer: "".concat(PREFIX$3, "-dateRangePickerContainer"),
    dateRangePicker: "".concat(PREFIX$3, "-dateRangePicker"),
    dateRangeBackdrop: "".concat(PREFIX$3, "-dateRangeBackdrop"),
};
var Root$1 = styles.styled('div')(function () {
    var _a;
    return (_a = {},
        _a["&.".concat(classes$3.dateRangePickerContainer)] = {
            position: 'relative',
        },
        _a["& .".concat(classes$3.dateRangePicker)] = {
            position: 'relative',
            zIndex: 1,
        },
        _a["& .".concat(classes$3.dateRangeBackdrop)] = {
            position: 'fixed',
            height: '100vh',
            width: '100vw',
            bottom: 0,
...
var DateRangePickerWrapper = function (props) {
    ...
    var wrapperClasses = classnames(classes$3.dateRangePicker, wrapperClassName);
    return (React.createElement(Root$1, { className: classes$3.dateRangePickerContainer },
        open && (React.createElement("div", { className: classes$3.dateRangeBackdrop, onKeyPress: handleKeyPress, onClick: handleToggle })),
...
var DateRangePickerExporter = function (props) { return (React.createElement(StylesProvider, { generateClassName: generateClassName },
